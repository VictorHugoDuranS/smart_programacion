...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <form class="needs-validation" method="POST"  action="{{ route('historiales.update',$maquina1->id) }}">
                 

                 <!--para poder insertar datos se necesita enviar un token, laravel es extricto con esto asi que no debe faltal -->
                 {!! csrf_field() !!}        
                 
                 <!-- el put es para poder actualizar los datos despues dce aceptar el formulario  --> 
                 {!! method_field('PUT') !!}
                 ...
                 <div class="form-row">
                     ...
                     <input type="tetx" name="programada"  value="{{$maquina1->programada}}" class="form-control" id="validationCustom01"  required>
